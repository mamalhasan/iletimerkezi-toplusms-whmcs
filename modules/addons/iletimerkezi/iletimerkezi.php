...
function iletimerkezi_activate() {
    ...
    $query = "CREATE TABLE IF NOT EXISTS `mod_iletimerkezi_messages` (`id` int(11) NOT NULL AUTO_INCREMENT,`sender` varchar(40) NOT NULL,`to` varchar(15) NULL,`text` text NULL,`msgid` varchar(50) NULL,`status` varchar(10) NULL,`errors` TEXT NULL,`logs` TEXT NULL,`user` int(11) NULL,`datetime` datetime NOT NULL,PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;";
	$result = mysql_query($query);

    $query = "CREATE TABLE IF NOT EXISTS `mod_iletimerkezi_settings` ( `id` int(11) NOT NULL AUTO_INCREMENT,`apiparams` varchar(500) NOT NULL,`wantsmsfield` int(11) NULL,`gsmnumberfield` int(11) NULL,`version` varchar(6) NULL,PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;";
	$result = mysql_query($query);

    $query = "INSERT INTO `mod_iletimerkezi_settings` ( `apiparams`, `wantsmsfield`, `gsmnumberfield`, `version`) VALUES ( '', 0, 0,'1.0');";
	$result = mysql_query($query);

    $query = "CREATE TABLE IF NOT EXISTS `mod_iletimerkezi_templates` (`id` int(11) NOT NULL AUTO_INCREMENT,`name` varchar(50) NOT NULL,`type` enum('client','admin') NOT NULL,`admingsm` varchar(255) NOT NULL,`template` varchar(240) NOT NULL,`variables` varchar(500) NOT NULL,`active` tinyint(1) NOT NULL,`extra` varchar(3) NOT NULL,`description` TEXT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=13;";
	$result = mysql_query($query);
