...
$hook = array(
    ...
    'description' => array(
        ...
        'english' => 'Domainin yenilenmesine {x} gün kala mesaj gönderir'
    ),
    'type' => 'client',
    'extra' => '15',
    'defaultmessage' => 'Sayin {firstname} {lastname}, {domain} alanadiniz {expirydate}({x} gun sonra) tarihinde sona erecektir. Yenilemek icin sitemizi ziyaret edin. www.whmcssms.com',
